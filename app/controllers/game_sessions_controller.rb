class GameSessionsController < ApplicationController
  ...
  def show
    ...
    ActionCable.server.broadcast("game_session_channel_#{@game_session.id}", player: current_user.username, round_id: @round.id, new_round_link: helpers.link_to('Join next', round_round_participations_path(@round), method: :post))
  end
end
